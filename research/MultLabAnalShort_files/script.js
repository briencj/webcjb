...
var gDocTable = new Array(
   new hrefList("slide0102.htm", 1, 1),
   new hrefList("slide0106.htm", 1, 2),
   new hrefList("slide0156.htm", 1, 3),
   new hrefList("slide0157.htm", 0, 0),
   new hrefList("slide0134.htm", 1, 4),
   new hrefList("slide0043.htm", 1, 5),
   new hrefList("slide0104.htm", 1, 6),
   new hrefList("slide0062.htm", 1, 7),
   new hrefList("slide0056.htm", 1, 8),
   new hrefList("slide0150.htm", 1, 9),
   new hrefList("slide0151.htm", 1, 10),
   new hrefList("slide0154.htm", 1, 11),
   new hrefList("slide0155.htm", 0, 0),
   new hrefList("slide0060.htm", 1, 12),
   new hrefList("slide0129.htm", 1, 13),
   new hrefList("slide0130.htm", 1, 14),
   new hrefList("slide0131.htm", 1, 15),
   new hrefList("slide0142.htm", 1, 16),
   new hrefList("slide0144.htm", 1, 17),
   new hrefList("slide0137.htm", 1, 18),
   new hrefList("slide0145.htm", 1, 19),
   new hrefList("slide0138.htm", 1, 20),
   new hrefList("slide0136.htm", 0, 0),
   new hrefList("slide0146.htm", 0, 0),
   new hrefList("slide0147.htm", 0, 0),
   new hrefList("slide0139.htm", 1, 21),
   new hrefList("slide0143.htm", 1, 22),
   new hrefList("slide0132.htm", 1, 23),
   new hrefList("slide0103.htm", 1, 24)
);
